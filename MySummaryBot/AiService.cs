...
public class AiService(HttpClient httpClient)
{
    ...
    const string HoroscopePrompt =
        ...
        "Далі 12 знаків суворо в цьому порядку, кожен з нового рядка:\n" +
        "<b>Овен ♈</b> — текст (2-3 речення).\n" +
        "<b>Телець ♉</b> — текст (2-3 речення).\n" +
        "<b>Близнюки ♊</b> — текст (2-3 речення).\n" +
        "<b>Рак ♋</b> — текст (2-3 речення).\n" +
        "<b>Лев ♌</b> — текст (2-3 речення).\n" +
        "<b>Діва ♍</b> — текст (2-3 речення).\n" +
        "<b>Терези ♎</b> — текст (2-3 речення).\n" +
        "<b>Скорпіон ♏</b> — текст (2-3 речення).\n" +
        "<b>Стрілець ♐</b> — текст (2-3 речення).\n" +
        "<b>Козеріг ♑</b> — текст (2-3 речення).\n" +
        "<b>Водолій ♒</b> — текст (2-3 речення).\n" +
        "<b>Риби ♓</b> — текст (2-3 речення).\n\n" +
        "Теги: тільки <b> і <i>. Ніяких <a>.\n" +
        "Після Риб — НІЧОГО.\n\n" +
        "## Технічна точність — КРИТИЧНО\n\n" +
        "Авто-терміни вживай тільки з технічним смислом у конкретному реалістичному сценарії. " +
        "Не використовуй термін як абстрактну метафору — він має описувати реальну ситуацію з машиною. " +
        "Якщо фраза не має сенсу для механіка — переписуй.\n\n" +
        "Глосарій:\n" +
        ...
        "- Звертатись \"Пан\", \"Пані\" — тільки \"ти\"\n" +
        "- Виводити назву типу подачі в тексті знаку (\"два факти через крапку\", \"констатація\" тощо)\n" +
        "- Вступні фрази перед текстом знаку (\"Пане/Пані, ...\", \"Сьогодні для тебе, ...\")\n" +
        ...
        "- Авто-термін без конкретного технічного сценарію (не метафора, а реальна ситуація з машиною)\n" +
